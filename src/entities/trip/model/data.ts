...
const azoresRoute: TripRoute = {
  name: 'Центральная группа Азор',
  duration: '8 дней',
  extent: '4 острова, ~146 миль',
  legend: travelLegend,
  mapCaption: 'Нитка Фаял — Сан-Жоржи — Терсейра — Пику, карту готовим',
  mapPoints: [],
  itinerary: {
    title: 'Неделя на Азорах, день за днём',
    intro:
      'Кольцо по центральной группе архипелага: из Хорты на Сан-Жоржи, дальше Терсейра и Пику, и обратно на Фаял. Около 146 миль за неделю — переходы длиннее средиземноморских, это открытая Атлантика.',
    days: [
      {
        label: 'День 1',
        title: 'Посадка в Хорте',
        text: 'Встречаемся в марине острова Фаял: размещение по каютам, знакомство с капитаном и брифинг по безопасности. Причальные стены здесь расписаны сотнями экипажей, пересёкших Атлантику. Вечером ужин в Peter Café Sport.',
      },
      {
        label: 'День 2',
        title: 'Переход на Сан-Жоржи',
        text: 'Поднимаем паруса и уходим из Хорты — 22 мили открытой воды, по пути часто выходят дельфины. К вечеру входим в Велаш: маленький порт зажат между океаном и двухсотметровыми скалами.',
      },
      {
        label: 'День 3',
        title: 'Фажаны Сан-Жоржи',
        text: 'День на острове: спускаемся к фажанам — узким лавовым террасам у подножия обрывов, куда не доходят туристические тропы. Главная — Фажан-де-Санту-Кришту с лагуной изумрудной воды. Вечером в Велаше пробуем сыр, который делают только здесь.',
      },
      {
        label: 'День 4',
        title: 'Переход на Терсейру',
        text: 'Долгий отрезок вдоль побережья — 49 миль. К вечеру приходим в Ангра-ду-Эроишму: мощёные улицы, собор XVI века и крепостные стены, весь центр в списке Всемирного наследия ЮНЕСКО.',
      },
      {
        label: 'День 5',
        title: 'День на Терсейре',
        text: 'День без парусов. Гуляем по Ангре: старые площади, белокаменные церкви и рыбные рестораны в порту. Для желающих — спуск в вулканическую пещеру Алгар-ду-Карван с подземным озером.',
      },
      {
        label: 'День 6',
        title: 'Переход на Пику',
        text: 'Самый длинный переход недели — 54 мили. Пику видно задолго до подхода: вулканический конус поднимается прямо из океана. Швартуемся в Лажеш-ду-Пику, бывшей столице китобоев.',
      },
      {
        label: 'День 7',
        title: 'Пику и возвращение на Фаял',
        text: 'Утром — виноградники Пику на застывшей лаве, тоже объект ЮНЕСКО, и музей китобойного промысла. Днём короткий переход обратно в Хорту, 21 миля. Вечером прощальный ужин на борту.',
      },
      {
        label: 'День 8',
        title: 'Высадка',
        text: 'Завтрак на борту, сборы и высадка утром. Помогаем с трансфером и делимся фотографиями недели.',
      },
    ],
    note: 'Расписание живое: океан и прогноз могут поменять порядок дней, но не сам маршрут.',
  },
}
...
export const trips: Trip[] = [
  ...
  },
  {
    id: 'azores',
    group: 'travel',
    geo: 'Азорские острова',
    year: '2027',
    price: '1 800 €',
    priceUnit: 'за гостя',
    tagline:
      'Неделя в открытой Атлантике по центральной группе Азор: Фаял, Сан-Жоржи, Терсейра и Пику. Вулканические берега, лавовые террасы над океаном и марина Хорта, где стены расписаны экипажами, пересёкшими океан.',
    cover: '/photos/azores/under-sail.webp',
    coverAlt:
      'Яхта под парусом в крене у зелёного азорского берега, вдоль борта белый бурун',
    photos: [
      {
        ...
        caption: 'Переход между островами',
      },
      {
        src: '/photos/azores/coast-peak.webp',
        alt: 'Зелёный склон круто обрывается в океан, у подножия скалы и полоса прибоя',
        caption: 'Зелёные склоны над океаном',
      },
      {
        src: '/photos/azores/cockpit-dusk.webp',
        alt: 'Кокпит яхты на закате: штурвал, бухты снастей и флаг на корме, вдали силуэты гор',
        caption: 'Закат из кокпита',
      },
      {
        src: '/photos/azores/crater-lakes.webp',
        alt: 'Вид с высоты на кратерные озёра Сети-Сидадеш среди зелёных склонов',
        caption: 'Кратерные озёра Сети-Сидадеш',
      },
      {
      ...
      },
      {
        ...
        caption: 'Ужин в кокпите на стоянке',
      },
      {
      ...
      },
      {
        ...
        caption: 'Вечер на борту под гирляндой',
      },
    ],
    reviewIds: [],
    harbor: {
      port: 'Хорта, Фаял',
      coords: '38°32′N · 28°37′W',
      season: 'Май 2027',
      crew: 'до 8 гостей',
      note: 'Порт старта и финиша — марина Хорта на острове Фаял. Выход 15–22 мая 2027 года.',
    },
    departures: [{ id: 'azores-1', dates: '15–22.05', route: azoresRoute }],
  },
  {
    id: 'marmaris',
    group: 'race',
